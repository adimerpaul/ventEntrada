...
class CarteleraController extends Controller{
    ...
    public function disponibles(){
        return Cartelera::select("movies.title","movies.image","movies.urlVideo","movies.director","movies.reparto","movies.sinopsis","movies.genero","movies.duracion","movies.clasificacion","movies.idioma","movies.subtitulos","movies.formato","movies.fechaEstreno","movies.preVenta")
            ...
            ->groupBy("movies.title","movies.image","movies.urlVideo","movies.director","movies.reparto","movies.sinopsis","movies.genero","movies.duracion","movies.clasificacion","movies.idioma","movies.subtitulos","movies.formato","movies.fechaEstreno","movies.preVenta")
